...
async function initSite(){
    ...
    await Promise.all([
        ...
        loadComponent("workflow-automation-sect1","./components/ser_workflow_aut_sec1.html"),

        loadComponent("workflow-automation-sect2","./components/ser_workflow_aut_sec2.html"),
