...
async function initSite(){
    ...
    await Promise.all([
        ...
        loadComponent("sec1-workflow-automation","./components/Services/Workflow Automation/sec1.html"),

        loadComponent("sec2-workflow-automation","./components/Services/Workflow Automation/sec2.html"),

        loadComponent("sec3-workflow-automation","./components/Services/Workflow Automation/sec3.html"),
