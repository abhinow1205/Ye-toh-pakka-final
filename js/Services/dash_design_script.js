...
async function initSite(){
    ...
    await Promise.all([
        ...
        loadComponent("sec1-dashboard-design","./components/Services/Dashboard Design/sec1.html"),

        loadComponent("sec2-dashboard-design","./components/Services/Dashboard Design/sec2.html"),

        loadComponent("sec3-dashboard-design","./components/Services/Dashboard Design/sec3.html"),
