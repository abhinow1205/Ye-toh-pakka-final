...
async function initSite(){
    ...
    await Promise.all([
        ...
        loadComponent("sec1-predictive-analytics","./components/Services/Predictive Analysis/sec1.html"),

        loadComponent("sec2-predictive-analytics","./components/Services/Predictive Analysis/sec2.html"),

        loadComponent("sec3-predictive-analytics","./components/Services/Predictive Analysis/sec3.html"),
