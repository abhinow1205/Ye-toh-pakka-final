...
async function initSite(){
    ...
    await Promise.all([
        ...
        loadComponent("sec1-automated-reporting","./components/Services/Automated Reporting/sec1.html"),

        loadComponent("sec2-automated-reporting","./components/Services/Automated Reporting/sec2.html"),

        loadComponent("sec3-automated-reporting","./components/Services/Automated Reporting/sec3.html"),
