...
export function initNavbar(){
  ...
  // Paste the Google Apps Script "Web app" URL from step 5 below
  const SHEET_ENDPOINT = 'https://script.google.com/macros/s/AKfycbxN04jU3otH2_hTRuVHFhSfyO8e6WF3w3WjlfHOhMeUmh09Vl49fAJ6hrRi1m-sdlQB/exec';
  ...
  form.addEventListener('submit', async function (e) {
    ...
    try {
      // Apps Script web apps don't send CORS headers, so we use no-cors
      // and can't read the response — we optimistically assume success.
